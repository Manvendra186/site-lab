...
export const metadata: Metadata = pageMeta({
  title: "Reserve — The Alkari",
  description:
    "Reserve a stay at the haveli. Tell us when you would like to come, and which suite you would like. We will do the rest.",
  path: "https://alkari.example/reserve",
});
    ...
    <>
      ...
      <section className="pb-20 md:pb-28">
        <Container>
              ...
              <div className="border border-sandstone bg-mist p-8">
                ...
                <ul className="mt-4 grid gap-3 text-sm leading-6 text-ink/75">
                  <li className="flex items-start gap-3">
                    <span
                      aria-hidden="true"
                      className="mt-2 block h-1.5 w-1.5 shrink-0 rotate-45 bg-gold"
                    />
                ...
                <div className="mt-8 border-t border-sandstone pt-6">
          ...
          <div className="mt-16 grid gap-8 border-t border-sandstone pt-12 md:grid-cols-4">
            {RESERVE.reach.map((r, i) => (
              <Reveal key={r.title} delay={i * 80}>
                <Lineage number={String(i + 1).padStart(2, "0")} label={r.title} />
