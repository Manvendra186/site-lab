    ...
    <section className="py-24 md:py-36">
      <Container>
        <div className="max-w-xl">
          <Label>Lost in the fort</Label>
          <h1 className="mt-4 font-display text-5xl tracking-tight md:text-6xl">
            This page is not in the haveli.
          </h1>
          <p className="mt-6 max-w-md text-base leading-7 text-ink/75">
            The lane you followed does not lead anywhere. Let us walk you back to the house.
          </p>
          <div className="mt-8 flex flex-wrap gap-x-10 gap-y-4">
            <Cta href="/">Return to the haveli</Cta>
