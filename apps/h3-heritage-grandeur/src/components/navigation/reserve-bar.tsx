...
export function ReserveBar() {
  ...
  return (
    <div className="sticky bottom-0 z-40 border-t border-sandstone bg-ivory lg:hidden">
      <Link
        href={RESERVE_HREF}
        className="block py-4 text-center text-[13px] uppercase tracking-[0.18em] text-maroon"
      >
        Reserve a stay
      </Link>
    </div>
